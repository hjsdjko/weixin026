...
public class DiscussyinletuijianController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,DiscussyinletuijianEntity discussyinletuijian,
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DiscussyinletuijianEntity discussyinletuijian, 
		HttpServletRequest request){
        EntityWrapper<DiscussyinletuijianEntity> ew = new EntityWrapper<DiscussyinletuijianEntity>();
    ...
    public R info(@PathVariable("id") Long id){
		...
		discussyinletuijian = discussyinletuijianService.selectView(new EntityWrapper<DiscussyinletuijianEntity>().eq("id", id));
    ...
    public R autoSort(@RequestParam Map<String, Object> params,DiscussyinletuijianEntity discussyinletuijian, HttpServletRequest request,String pre){
        EntityWrapper<DiscussyinletuijianEntity> ew = new EntityWrapper<DiscussyinletuijianEntity>();
