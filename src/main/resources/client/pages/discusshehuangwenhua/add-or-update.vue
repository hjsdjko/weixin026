	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`discusshehuangwenhua`, this.ruleForm.id);
...
//跨表计算判断
				...
				if(crossrefid && crossuserid) {
					...
					let res = await this.$api.list(`discusshehuangwenhua`, params);
                ...
                //跨表计算
						if(this.ruleForm.id){
							await this.$api.update(`discusshehuangwenhua`, this.ruleForm);
						}else{
							await this.$api.add(`discusshehuangwenhua`, this.ruleForm);
						}
						uni.setStorageSync('discusshehuangwenhuaCleanType',true);
